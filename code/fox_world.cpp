...
inline bool32
AreInSameChunk(world *world, world_position *pos1, world_position *pos2)
{
...
AddV3ToWorldPosition(world *world, world_position *pos, v3 offset)
{
...
internal void
ChangeEntityLocation(memory_arena *arena, world *world, low_entity *lowEntity, uint32 lowEntityIndex,
